...
\begin{enumerate}
	\item Abstract
	\item Introduction
	\item \ac{vit} need Registers
	\item Comparison to papers with performance improvements of \ac{vit}s
	\item Conclusion
\end{enumerate}
...
Explanation of \ac{vit}s \cite{10.1145/3505244} \cite{dosovitskiy2021imageworth16x16words} \cite{ruan2022visiontransformersstateart} \cite{Liu2024-lm}


\section{Using Transistors in \acp{vit} networks}
...
\section{Comparison to papers with performance improvements of \ac{vit}s}
